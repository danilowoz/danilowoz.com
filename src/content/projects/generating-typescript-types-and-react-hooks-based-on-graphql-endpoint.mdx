...
```sh
npm i @graphql-codegen/cli @graphql-codegen/import-types-preset @graphql-codegen/typescript @graphql-codegen/typescript-operations @graphql-codegen/typescript-react --save-dev
```
...
I've made a repository available with the code above, and you can [check it out here](https://github.com/danilowoz/ts-gql-jsx).
