...
export const metadata = {
  ...
  tagline:
    'How a code editor for beginner developers focused on ReactJS might look.',
...
This experiment was definitely worth it! After posting on Twitter, I got a lot of exciting suggestion and thoughts that I want to share here:
