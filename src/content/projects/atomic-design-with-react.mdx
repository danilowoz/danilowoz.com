export const metadata = {
  ...
  date: '2018-08-01',
  categories: ['Article', 'Methodology', 'Storybook'],
  cover: '/images/atomic-design-with-react/cover.jpg',
...
I'm a big enthusiast of componentization and style guides, so if you have more experience with atomic design or even another approach feel free to reach me out. **Tweet me [@danilowoz](https://twitter.com/danilowoz) and let's chat.**
