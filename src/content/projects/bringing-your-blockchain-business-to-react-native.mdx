export const metadata = {
  ...
  categories: ['React Native', 'Blockchain', 'Development thoughts'],
  cover: './images/bringing-your-blockchain-business-to-react-native/hero.jpeg',
}
...
In case you have any questions or facing any issues, feel free to get in touch with us.
