export const metadata = {
  ...
  cover: '/images/css-display-grid-and-sketch-layout/asset-1.jpeg',
...
![12-column grid in Display grid and you can see the full code [here](https://codepen.io/danilowzn/pen/NvzYoN)](/images/css-display-grid-and-sketch-layout/asset-2.png)
...
![Layout settings](/images/css-display-grid-and-sketch-layout/asset-3.png)
...
![Classic desktop website, but in display grid and you can see the full code [here](https://codepen.io/danilowzn/pen/rzRzzE?editors=1100)](/images/css-display-grid-and-sketch-layout/asset-4.jpeg)
...
![Classic mobile website, you can see the full code [here](https://codepen.io/danilowzn/pen/rzRzzE?editors=1100)](/images/css-display-grid-and-sketch-layout/asset-5.jpeg)
...
![Layout grid on desktop](/images/css-display-grid-and-sketch-layout/asset-6.jpeg)

On the mobile it can look like this:

![At same grid on mobile](/images/css-display-grid-and-sketch-layout/asset-7.jpeg)
