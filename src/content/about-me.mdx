...
As a result of this and many interactions with the development community, I’ve begun writing some open-source projects, which gave me a lot of opportunities, from working with many awesome people from all around the world to getting a new position abroad. Therefore, the main lesson so far is that the more I share knowledge and teach my colleagues, the more I see that my learning journey is far from over.
